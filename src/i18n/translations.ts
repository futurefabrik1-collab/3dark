...
export const translations = {
  ...
  projectsList: {
    en: [
      ...
      { year: "VFX", title: "Alfons Zitterbacke", subtitle: "Scan for Set Extension", description: "3D set scanning for VFX workflows in film production — rapid capture, high detail fidelity, seamless integration into post-production pipelines.", tag: "Producers", showMedia: true },
    ...
    de: [
      ...
      { year: "VFX", title: "Babylon Berlin – Drachenburg", subtitle: "Scan für Set Extension", description: "In der Serie Babylon Berlin demonstriert der Industrielle Alfred Nyssen einen ersten Raketenprototypen. Für die Außenshots der Drachenburg lieferten wir den 3D-Scan als VFX-Asset.", tag: "Produzenten", showMedia: true },
      { year: "VFX", title: "Alfons Zitterbacke", subtitle: "Scan für Set Extension", description: "3D-Set-Scanning für VFX-Workflows in der Filmproduktion — schnelle Erfassung, hohe Detailtreue, nahtlose Integration in Post-Production-Pipelines.", tag: "Produzenten", showMedia: true },
