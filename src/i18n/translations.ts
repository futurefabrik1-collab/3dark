...
export const translations = {
  ...
  notFound: {
    en: {
      ...
      body: "The link may be outdated, or the address was mistyped.",
      home: "Back to the homepage",
    },
    de: {
      label: "Fehler 404",
      h1: "Diese Seite gibt es nicht",
      body: "Der Link ist vielleicht veraltet, oder die Adresse wurde falsch eingegeben.",
  ...
  hero: {
    en: {
      ...
      pauseVideo: "Pause showreel",
      playVideo: "Play showreel",
      scroll: "Scroll",
    ...
    de: {
      ...
      pauseVideo: "Showreel anhalten",
      playVideo: "Showreel abspielen",
      scroll: "Scrollen",
  ...
  contactForm: {
    en: {
      ...
      errorTitle: "Error",
      errorDesc: "Your message could not be sent. Please try again, or email us at contact@futurefabrik.com.",
      errorTooMany: "Too many messages in a short time. Please wait a minute and try again.",
      errorInvalid: "Please check your details and try again.",
      privacyNote: "We use your details only to handle your enquiry.",
    ...
    de: {
      ...
      errorTitle: "Fehler",
      errorDesc: "Ihre Nachricht konnte nicht gesendet werden. Bitte versuchen Sie es erneut oder schreiben Sie uns an contact@futurefabrik.com.",
      errorTooMany: "Zu viele Nachrichten in kurzer Zeit. Bitte warten Sie eine Minute und versuchen Sie es erneut.",
      errorInvalid: "Bitte prüfen Sie Ihre Angaben und versuchen Sie es erneut.",
      privacyNote: "Wir verwenden Ihre Angaben ausschließlich zur Bearbeitung Ihrer Anfrage.",
  ...
  contact: {
    en: {
      ...
      serviceBy: "A service by Future Fabrik",
      legalNotice: "Legal notice",
      privacy: "Privacy policy",
      germanOnly: "This page is available in German only.",
    },
    de: {
      sectionLabel: "Kontakt",
      h2: "Erzählen Sie uns von",
      h2Highlight: "Ihrem Projekt",
      ...
      emailLabel: "Oder schreiben Sie uns direkt",
      footerTagline: "Ein Archiv von Räumen, die nie für die Ewigkeit gedacht waren.",
      serviceBy: "Ein Service der Future Fabrik",
